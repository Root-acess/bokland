...
if (isset($_POST['submit'])) {
    ...
    $c_des = $_POST['category_description'];

    // Insert the data
    $insert = mysqli_query($conn, "INSERT INTO `categories_master`( `c_name`, `c_description`) VALUES ('$c_Name','$c_des')");
...
<head>
    ...
    <title>Bokland - Add Category</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="addCategory.php" active>Add Categories</a>
                    </li>
                    <li class="nav-item">
    ...
    <header class="header">
        <h1 class="jacquard">Add a New Category</h1>
    </header>
    ...
    <div class="form-container">
        <form method="post" action="addCategory.php">
            ...
            <div class="mb-2">
                ...
                <textarea class="form-control" id="categoryDescription" name="category_description" rows="2" required></textarea>
            </div>
